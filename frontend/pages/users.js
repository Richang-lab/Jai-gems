    ...
    tableBody.innerHTML = users.map(user => {
      ...
      return `
        <tr>
          ...
          <td data-label="Email" style="color: var(--text-secondary);">${escapeHtml(user.email || '—')}</td>
          <td data-label="Role"><span class="badge ${rb.class}">${rb.label}</span></td>
          <td data-label="Phone" style="color: var(--text-secondary);">${escapeHtml(user.phone || '—')}</td>
